...
MODEL_CKPT_PATH = "best_models_from_hpo/ia/trial_0059/best_model.pt"

# --- test data ---
TEST_SCORES_PATH = r"../../data/Itunes-Amazon/big_scores_ia__test_full.csv"
TEST_RAW_PATH    = r"../../data/Itunes-Amazon/test_full.csv"

# --- output ---
OUT_DIR = r"Meta_Matcher/scripts/predictions"
OUT_CSV = os.path.join(OUT_DIR, "Itunes-Amazon_test_predictions.csv")
