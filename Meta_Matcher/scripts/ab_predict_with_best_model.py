...
DATASET_NAME = "abt-buy_textual"

# --- trained model checkpoint (.pt) ---
MODEL_CKPT_PATH = "best_models_from_hpo/ab/trial_0088/best_model.pt"

# --- test data ---
TEST_SCORES_PATH = r"../../data/abt-buy_textual/big_scores_ab__test_full.csv"
TEST_RAW_PATH    = r"../../data/abt-buy_textual/test_full.csv"

# --- output ---
OUT_DIR = r"Meta_Matcher/scripts/predictions"
OUT_CSV = os.path.join(OUT_DIR, "abt-buy_textual_test_predictions.csv")
...
def merge_scores_and_raw(
    ...
    # optional: aggregates from logits (or from probs if use_logits=False; still defined)
