...
DATASET_NAME = "Amazon-Google_structured"

# --- trained model checkpoint (.pt) ---
MODEL_CKPT_PATH = "best_models_from_hpo/ag/trial_0060/best_model.pt"

# --- test data ---
TEST_SCORES_PATH = r"../../data/Amazon-Google_structured/big_scores_ag__test_full.csv"
TEST_RAW_PATH    = r"../../data/Amazon-Google_structured/test_full.csv"

# --- output ---
OUT_DIR = r"Meta_Matcher/scripts/predictions"
OUT_CSV = os.path.join(OUT_DIR, "Amazon-Google_structured_test_predictions.csv")
