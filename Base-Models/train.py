...
from Evaluation.eval_while_training_base_models import (
...
train_dblp, validation_dblp, test_dblp = dm.data.process(
    path=r"../data/dblp_scholar_exp_data/",
    train='train_base.csv',
    validation='validation_full.csv',
    test='test_full.csv',
    cache=False
...
datasets = {
    ...
    "dblp": (train_dblp, validation_dblp, test_dblp)
}


models = ["sif", "attention", "hybrid", "rnn"]

save_dir = r"Base-Model Checkpoints"
